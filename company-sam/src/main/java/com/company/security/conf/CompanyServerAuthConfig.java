 ...
 * @author  flora
 */
public class CompanyServerAuthConfig  implements ServerAuthConfig {
    ...
    public CompanyServerAuthConfig(String layer, String appContext, CallbackHandler handler,
    ...
    public ServerAuthContext getAuthContext(String authContextID, Subject serviceSubject,
        ...
        return new CompanyServerAuthContext(handler, serverAuthModule);
    }
