package com.company.security.conf;
 ...
 * @author flora
 */
public class CompanyAuthConfigProvider implements AuthConfigProvider {
    ...
    public CompanyAuthConfigProvider(ServerAuthModule serverAuthModule) {
     ...
     * @param factory
     */
    public CompanyAuthConfigProvider(Map<String, String> properties, AuthConfigFactory factory) {
    ...
    public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler)
        ...
        return new CompanyServerAuthConfig(layer, appContext, handler, providerProperties, serverAuthModule);
    }
